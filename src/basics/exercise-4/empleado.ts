 ...
 * subclase (Interface). También puede tener propiedades o métodos que tengan ya una implementación y los
 * cuales serán heredados por la sublclase (Herencia). También se puede sobreescribir los métodos y
 * se pueden marcar con la palabra reservada @override. Permite el uso de modificadores de acceso
 */
